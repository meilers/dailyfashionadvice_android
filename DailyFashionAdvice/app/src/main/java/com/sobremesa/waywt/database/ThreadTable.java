...
public class ThreadTable {
    ...
    public static String[] ALL_COLUMNS = new String[]{ID, THREAD_ID, TITLE, DESCRIPTION, TAG, CREATED};
    public static String[] FULL_ALL_COLUMNS = new String[]{FULL_ID, FULL_THREAD_ID, FULL_TITLE, FULL_DESCRIPTION, FULL_TAG,  FULL_CREATED};
